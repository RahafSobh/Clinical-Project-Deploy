...
TEXT_COL = "adm_diagnosis"
ICD9_COL = "icd9_str"


def build_preprocessor(
    feature_set: str = "triage",
    text_features: int = 300,
    icd9_features: int = 400
) -> ColumnTransformer:
    ...
    categorical = (
        CATEGORICAL_TRIAGE + CATEGORICAL_FULL_EXTRA
        if feature_set == "full"
        else CATEGORICAL_TRIAGE
    )
